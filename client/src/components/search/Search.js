    ...
    <div className="container">
      ...
      <div className="w-100 py-3 mx-auto d-flex justify-content-center text-center align-items-center">
        <input
          ...
          type="text"
          placeholder="type to search and click enter ..."
          onKeyPress={(event) => getMovieRequest(event)}
        />
      </div>
      <div className="content-search d-flex flex-column align-items-center">
        {!seenJoke && (
          <div className="font-hand fs-3 fst-italic mt-5 mb-3 text-center">
            I regret to inform you that this is no horror movies&apos; page.
            {' '}
            <br />
        ...
        {searchMessage.includes('We couldn') && (
        <div>
          <FontAwesomeIcon icon={faBan} className="text-danger fs-1" />
        </div>
        )}
