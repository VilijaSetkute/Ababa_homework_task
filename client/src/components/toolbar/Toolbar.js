...
import {
  faRightFromBracket, faMagnifyingGlass, faBars, faUserAstronaut,
    ...
    <div>
      ...
      <div className="py-1 toolbar-desktop">
        <div className="toolbar d-flex justify-content-between align-items-center">
          ...
          <div className="d-flex p-2 text-white align-items-center">
            <div>{user}</div>
            <div className="ms-2 cursor" onClick={logOut} aria-hidden="true">
              <FontAwesomeIcon icon={faRightFromBracket} className="my-1 fs-4" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-1 toolbar-mobile">
        <div className="toolbar">
          <div className="w-100 d-flex justify-content-between align-items-center p-2 text-white ">
            <div>
              <FontAwesomeIcon icon={faUserAstronaut} className="fs-2" />
              {' '}
              {user}
            </div>
          ...
          <div>
            {toggleMenu
                        && (
                        <div className="bg-mobile w-100 d-flex flex-column align-items-end p-2
                        text-white border-top border-danger position-absolute position-absolute__menu"
                        >
